...
#SBATCH -J vec_multik_landscape_thomas
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-9
#SBATCH --output=logs/vec_multik_landscape_thomas_%A_%a.out
#SBATCH --error=logs/vec_multik_landscape_thomas_%A_%a.err

# Trains vec_multik (vectorization=landscape, encoder_path=native, native
# feature budget -- see configs/runs/thomas/vec_multik_landscape_native.yaml's own
...
#   sbatch slurm/vec_multik_landscape_thomas.sh
