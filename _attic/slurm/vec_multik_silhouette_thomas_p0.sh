...
#SBATCH -J vec_multik_silhouette_thomas_p0
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-9
#SBATCH --output=logs/vec_multik_silhouette_thomas_p0_%A_%a.out
#SBATCH --error=logs/vec_multik_silhouette_thomas_p0_%A_%a.err
...
# 0 via --set method.params.p=0 -- p is an EXPERIMENTAL AXIS (run every
...
# under vec_multik_silhouette_native_p0/, separate from p=1's
...
#   sbatch slurm/vec_multik_silhouette_thomas_p0.sh
