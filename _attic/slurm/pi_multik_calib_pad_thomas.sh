...
#SBATCH -J pi_multik_calib_pad_thomas
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-8
#SBATCH --output=logs/pi_multik_calib_pad_thomas_%A_%a.out
#SBATCH --error=logs/pi_multik_calib_pad_thomas_%A_%a.err

# PI calibration padding-factor sweep, thomas, FUSED DTM k=5,10,15 (one
...
# results/thomas/dtm_k5+10+15/pi_multik/_runs/calib_pad<value>/seed_<seed>/
...
#   sbatch slurm/pi_multik_calib_pad_thomas.sh
