...
#SBATCH -J pi_multik_calib_q_nested_thomas
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-11
#SBATCH --output=logs/pi_multik_calib_q_nested_thomas_%A_%a.out
#SBATCH --error=logs/pi_multik_calib_q_nested_thomas_%A_%a.err

# PI calibration coverage sweep, nested_thomas, FUSED DTM k=5,10,15 (one
...
# models), 4 values of coverage q (method.params.pd_calibration_coverage,
...
# results/nested_thomas/dtm_k5+10+15/pi_multik/_runs/calib_q<value>/seed_<seed>/
...
#   sbatch slurm/pi_multik_calib_q_nested_thomas.sh
