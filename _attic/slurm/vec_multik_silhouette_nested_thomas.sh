...
#SBATCH -J vec_multik_silhouette_nested_thomas
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-9
#SBATCH --output=logs/vec_multik_silhouette_nested_thomas_%A_%a.out
#SBATCH --error=logs/vec_multik_silhouette_nested_thomas_%A_%a.err

# Trains vec_multik (vectorization=silhouette, encoder_path=native, native
# feature budget -- see configs/runs/nested_thomas/vec_multik_silhouette_native.yaml's own
...
# already exist (vec_multik_silhouette_native.yaml reads the identical process/design/
...
#   sbatch slurm/vec_multik_silhouette_nested_thomas.sh
