...
#SBATCH -J vec_multik_silhouette_nested_thomas_p2
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-9
#SBATCH --output=logs/vec_multik_silhouette_nested_thomas_p2_%A_%a.out
#SBATCH --error=logs/vec_multik_silhouette_nested_thomas_p2_%A_%a.err
...
#   sbatch slurm/vec_multik_silhouette_nested_thomas_p2.sh
