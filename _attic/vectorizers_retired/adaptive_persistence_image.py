# src/cloudforger/vectorizers/adaptive_persistence_image.py
#
# Retired per-diagram adaptive-sigma design. Superseded by the paper-faithful
# fixed-sigma PersistenceImager in persistence_image.py (see
# pi_sigma_diagnostics.ipynb / docs/pi_multik_report.tex Section 3.6 for why:
# the adaptive sigma sat at its floor for ~all H0 and ~99.7% of H1 diagrams,
# wasn't meaningfully adaptive, and its per-diagram sigma isn't covered by the
# stability guarantee in Adams et al. 2017). Kept only for comparison.
