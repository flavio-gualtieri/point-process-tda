...
#SBATCH -J vec_multik_silhouette_singlescale_thomas_k10_p3
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-9
#SBATCH --output=logs/vec_multik_silhouette_singlescale_thomas_k10_p3_%A_%a.out
#SBATCH --error=logs/vec_multik_silhouette_singlescale_thomas_k10_p3_%A_%a.err
...
# results/thomas/dtm_k10/vec_multik_silhouette_native_p3/seed_<seed>/.
#
# Submit from the point-process-tda repo root:
#   sbatch slurm/vec_multik_silhouette_singlescale_thomas_k10_p3.sh
