...
#SBATCH -J pi_multik_sweep_shared_conv_avg
#SBATCH -p sae
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-4
#SBATCH --output=logs/pi_multik_sweep_shared_conv_avg_%A_%a.out
#SBATCH --error=logs/pi_multik_sweep_shared_conv_avg_%A_%a.err

# pi_multik encoder/fusion sweep -- combo 2/6: encoder_mode=shared,
# fusion_mode=conv, fusion_pool=avg (== the old pi_multik_scaleconv preset:
# shared-weight encoder, Conv1d over the k axis then avg-pooled -- see
