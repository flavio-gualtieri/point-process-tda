# scripts/analyze_pi_experiments.py
import torch
...
RUNS = [
    ("H0", Path("results/experiment_02_pi/h0_results.pt")),
    ("H1", Path("results/experiment_02_pi/h1_results.pt")),
    #("H0 + H1", Path("results/experiment_02_pi/results.pt")),
]
...
plt.tight_layout()
plt.savefig("results/homology_comparison.png", dpi=150)
