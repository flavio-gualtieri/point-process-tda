...
LS  & $16\times128=2048$ & 6  & $0.132 \pm 0.008$ (3)  & $0.250 \pm 0.005$ (3) & \#\#\# & \#\#\# \\
SIL & $128$              & 12 & $0.165 \pm 0.013$ (3)  & $0.271 \pm 0.012$ (3) & \#\#\# & \#\#\# \\
BC  & $128$              & 6  & $0.196 \pm 0.014$ (3)  & $0.290 \pm 0.005$ (3) & \#\#\# & \#\#\# \\
\bottomrule
\end{tabular}
...
consistency. T = Thomas, NT = nested-Thomas; seed count $n$ in parentheses
...
\addlinespace
LS & $H_0$ only / $H_1$ only & \#\#\# & \#\#\# \\
BC & $H_0$ only / $H_1$ only & \#\#\# & \#\#\# \\
\bottomrule
\end{tabular}
\caption{Homology-dimension ablation (C3), $n=5$ seeds per arm, both design
distributions. Only the PI arm has been run so far; LS and BC rows are
pending. \#\#\# = not yet run.}
\label{tab:homology-ablation}
\end{table}

$H_1$ alone lands within noise of the label-shuffle floor
(Section~\ref{ssec:exp-summaries}) on both datasets, while $H_0$ alone is
statistically indistinguishable from the fused $H_0{+}H_1$ default. For the
persistence image, essentially all the recoverable signal is in $H_0$
