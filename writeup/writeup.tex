...
\todo{make the error floor a named quantity}
...
regions are occupied. In this case $DTM_k$ is more suitable because it works with a point's averagedistance to its
...
we expect this choice to pay off. Section
...
that consumes the fused scales is described in Section REF.
