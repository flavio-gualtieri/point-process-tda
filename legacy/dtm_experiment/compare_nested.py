...
# Feature set present under results_k5_nested (vihrs, ph_combined, pi_01,
# betti_cnn_01, fusion) -- collect_feature_results skips/warns on any
# feature with no results.pt yet, so it's safe to run this against a
...
RESULTS_DIR = Path(__file__).resolve().parent / f"results_k{k}_nested"
OUT_DIR = RESULTS_DIR / "summary_temp"
