# scripts/processing/params/new_betti.py
...
CONFIG_PATH = "/Users/qp252676/Desktop/point-process-tda/configs/params/processing/new_betti.yaml"
...
def main() -> None:
    ...
    stage_runners: dict[str, Any] = {
        "compute_betti": lambda dim_index, dim: pl.compute_betti_for_dim(dim),
    }
